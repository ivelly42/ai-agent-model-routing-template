...
## Free Model Routing Template

Use this when a buyer needs a repeatable way to choose the cheapest reliable model, agent, review path, and verification gate before an AI-agent run starts.

| Area | Routing Note |
| --- | --- |
| Product | Agent Ops Command Center |
| Package | Team license - 7 seats - $203 gross |
| Public Data | Public previews only |
| Private Delivery | Paid ZIP only after checkout, receipt, payout, or seller-dashboard proof |
| Routing Gate | Work type, default route, escalation rule, avoid rule, verification needed |
| Hold Rule | Hold if the model, tool, review path, or evidence gate is unclear |
| Delivery Evidence | Digest, manifest, and acceptance note after payment proof |
